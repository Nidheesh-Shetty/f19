    ...
    flex items-center justify-between">
                ...
                <main className="mx-auto mt-6 ml-6">
                    ...
                    <section className="mx-auto max-w-4xl p-5">
                        ...
                        <section className="bg-linear-to-b from-[#dff1dd]/80 to-[#7ba66a]/30 p-5 rounded-2xl shadow-xlbg-gray-50 shadow mb-6">
                            ...
                            <div className="flex gap-2 mb-3">
                                <input
                                    ...
                                    className="flex-1 bg-linear-to-bl from-amber-300/30 to-emerald-500/30 p-5 rounded-2xl shadow-xlbg-gray-50 shadow mb-2 px-3 py-2 "
                                />
                        ...
                        {/* Yearly Goals */}
                        <section className="bg-linear-to-b from-[#dff1dd]/80 to-[#7ba66a]/30 p-5 rounded-2xl shadow-xl">
